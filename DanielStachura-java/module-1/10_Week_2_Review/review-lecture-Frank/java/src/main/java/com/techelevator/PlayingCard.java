...
//*********************************************************************************************	
	...
	/**
	 * 2-arg constructor - allow the suer to create a card with a specific value and suit
	 */
...
//********************************************************************************************
// Getters	- allow the user to retrieve values in the private date members (Encapsulation
//********************************************************************************************
	/**
...
//******************************************************************************************************
// Setters	- allow user to change the values in private data members (Encapsulation)
//
// Not all data members require setters - if you dont want to allow a user to change the data, don't provide a setter
// If a data member has a getter without a setter is is said to be read-only (shape in this class)
//
//********************************************************************************************************
	/**
	...
	public void setValue(int value) {
		//since this function require access to the parameter passed by the user
...
//********************************************************************************************
	...
	private void determineColor() { // set the cardColor based on the cardSuit
		//because this method uses only data members (suit)
...
//********************************************************************************************
		...
		/**
		 * Define a .equals method to compare two PlayingCards to see if they are equal
		 *
		...
		public boolean equals(PlayingCard theOtherCard){
			...
			//
			// 		this. = represents the PlayingCard to the left of the .
			//
			...
			//
			//*****its kind of like yesterday, the .toString() didn't work for our class so we had to create our own .toString() method, we're just creating our own .equals() method to fit our class

			//****so basically whatever is inside the ( ) changes theOtherCard and the .value or .suit attaches to it
			//
			//So when we use it changes it to
			//(franksCard.value == johnsCard.value && franksCard.suit.equals(johnsCard.suit))
	 ...
	 * due to the Object class toString() didn't do what we wanted it to do
