...
//  access        return name(parameters)
	public static void   main(String[] args) {
        ...
        */
		...
		// Java does not how to compare two objects using .equals
		// If the PlayingCard class has a .equals(), it will used to do the compare
		System.out.println("is franksCard equal to johnsCard using .equals? " + (franksCard.equals(johnsCard)));

		System.out.println("is franksCard equal to myCard using .equals? " + (franksCard.equals(myCard)));
