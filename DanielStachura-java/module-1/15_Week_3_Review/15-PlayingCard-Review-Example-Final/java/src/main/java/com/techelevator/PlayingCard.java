...
public class PlayingCard {
	 ...
	 *        Java will ensure that an enum type only has values valid for teh enum (we don't have to check)
	...
	public CardValue setValue(int ivalue) {  // Set the CardValue based on an int value
		 ...
		 *           statements-to-run if value in the case matches the one in the swutch
		 *
