...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		/* Create a new instance of a String literal (a literal is a value that says what it is)
			...
			*
			*  A String is NOT a char and a car is NOT a String
			*
		*/
		...
		/*
		 * String is a class - class names start with Capital letter
		 *
		 * A Class is a description of what an object should look like and what it should/can do (its behavior) -
		 * 	**A LOT more tomorrow and next week**
		 *
		 *
		 ...
		 *		-cake is an OBJECT and recipe is the CLASS
		 *
		 ...
		 */
//				indexes:012345678911 - use index to reference individual chars using charAt()
		...
		// .substring(start-index,end-index) - return from the start-index to the end-index (but not the char at end-index)
		// Mc is at index 4 and 5, need to specify 4,6	//start at index 4 to index 6, but not what's at index 6
		System.out.println("Here is the Mc from the name: " + name.substring(4,6));
		System.out.println("Here is the middle Hal from the name: " + name.substring(6,9));

		String answer = "     Here is the answer    "; //you dont know if the user entered spaces at the terminal before or after

		System.out.println("The value in answer is: " + answer + " the end of it");
		System.out.println("The value in answer using trim() is: " + answer.trim());
	...
	//	.split(delimiter) - returns and array of strings containing the characters between the delimiter specified
		...
		String[] words = person.split(" ");
			//split the String in person based on the spaces and store the results in String[] words
