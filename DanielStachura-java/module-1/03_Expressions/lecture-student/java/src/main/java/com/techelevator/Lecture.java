...
//  type  type  function-name(parameters) - no parameters
    public int returnNotOne() {
        return 2;
    }  //2.0 (double) will error as we want to return an int
    ...
    */
    ...
    //the if statement allows you to execute statement conditionally
    ...
    //          }
    //          else if (condition) {
    //              what-to-do-if-the-nested-condition-is-true
    //          }
    //              else {
    //              what-to-do-if-the-condition-is-false
    //          }   end of if statement
    ...
    public boolean returnTrueFromIf() {
        ...
        return false;  // if the first returns true, the function stops
    }
    ...
    */
    ...
    // syntax: conidition ? result-if-true : result-if-false
    */
    public String returnFizzIfThreeUsingTernary(int number) {
        return (number == 3) ? "Fizz" : "";
                //if number == 3, result is "Fizz" otherwise result is ""
    }
    ...
    */
    public String returnFizzOrBuzzOrNothing(int number) {
        ...
        // return (number == 3) ? "Fizz" : (number == 5) ? "Buzz : ""; - this is ternary code
    }
