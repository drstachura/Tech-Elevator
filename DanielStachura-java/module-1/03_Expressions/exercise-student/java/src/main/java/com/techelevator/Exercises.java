...
public class Exercises {
	 ...
	 */
	//true = cigars between 40 and 60 inclusive
	//weekend = no cigar limit
	// if cigars >= 40 and <=60 = true
	// if weekend >= 40 = true
	...
	/*
	 ...
	 dateFashion(5, 5) → 1
	 */
	//you = stylish of your close 0-10
	//date = styish of date close
	//no table return 0
	//might get table return 1
	//got table return 2
	//>=8 = 2 OR
	//<=2 = 0
	//>2 and <8 = 1
	...
	public int dateFashion(int you, int date) {
		if ((you >=8 || date >=8) && (you > 2 && date > 2)){  //condition if 1 is greater than 8 AND both are greater than a 2
			return 2;
		}
		if (you <= 2 || date <=2) {
			return 0;
		}
		return 1;    //***'no need to create a statement for return 1 as that is the only other possible result left'***
	}
	...
	//if a+b >=10 and <=19 are forbidden -> just return 20
	 ...
	 */
	//1-5 is weekday 0 and 6 is weekend
	//weekday 7:00 weekend 10:00
	//vacation weekday is 10:00 weekend is OFF
	//
	 ...
	 */
	//n >=1 <=10 ==true
	// outsidemode is true - return true is n <=1 or >=10
