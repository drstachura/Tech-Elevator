...
class PaintCalculator {
    ...
    public static void main(String[] args) {
        ...
        // Step One:
        List<Wall> walls = new ArrayList<Wall>();     //decomment this line when you've done step one
        ...
        while (true) {
            ...
            if (userChoice.equals("1")) {
                // Step One:
                 Wall newWall = null;         //decomment this line when you've done step one
                ...
                if (shapeChoice.equals("1")) {
                    ...
                    // Step Two:
                   newWall = new RectangleWall(name, color, height, length);     //decomment this line when you've done step two
                } else if (shapeChoice.equals("2")) {
                    System.out.println("Enter wall side length >>> ");
                    int sideLength = Integer.parseInt(userInput.nextLine());

                    // Step Three:
                    newWall = new SquareWall(name, color, sideLength);        //decomment this line when you've done step three
                    ...
                    // Step Four:
                    newWall = new TriangleWall(name, color, height, base);    //decomment this line when you've done step four
                }

                // Step Two:
                System.out.println("Added " + newWall + " wall - "                //decomment this line when you've done step two
                ...
                int totalArea = 0;
                // Step One:                                                    //decomment this line when you've done step one
