...
public class UsePlayingCards {
	...
	public static void main(String[] args) {
		...
		//PlayingCard aPlayingCard = new PlayingCard(); // cannot instantiate because it is abstract
	...
	//							sub class method based on the object assigned to the super class object
