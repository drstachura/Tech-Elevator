...
//
//abstract classes are meant to be super classes - generic description to a more specific description
// vehicle(super class) is generic description ->
// 		automobile, boat, plane - more specific description of the vehicle(sub class)
//
...
abstract public class PlayingCard { //generic PlayingCard - cannot be instantiated
	...
	// to allow for Polymorphism a super lass must define any method that is to be Polymorphic
	// 		even if it doesn't do anything
	// the sub class may override the method to actually do something
	...
	//
	// abstract means we don't know the details, we just know we need it
	//
	//abstract methods are frequently used for Polymorphism
	// 		and/or the super class wants to require a sub class to implement the behavior
	//
...
//	public void showCard() {}  // Required for Polymorphism - does nothing
	abstract public void showCard();	// required for Polymorphism - making it abstract REQUIRES the sub class to override
}
