...
public class AmericanPlayingCard extends PlayingCard{ //this is sub class of PlayingCard
	...
	public String toString() {
		return "AmericanPlayingCard: " 
			  ...
			  +" - Suit: " + suit 		//we have direct access to the protected data
	//		  +" - Suit: "  + getSuit()	//use the super class method to get the suit because it is private in super class
										//	must use .get to access private data
