...
public class AmericanPlayingCard extends PlayingCard{	// extends indicates inheritance
	/************************************************************************************************
	 * Constants for values related to American Playing Cards - NEW DATA
	 ***********************************************************************************************/	
	private static final int    DEFAULTCARDVALUE = 0;		//static - all AmericanPlayingCards share these values
	...
	/**************************************************************************************************
	 * Maps used to validate/limit suits, colors and value names for American Playing Cards - NEW DATA
	 *************************************************************************************************/	
	//					Key		Value
	//					suit	color		       new HashMap();  	  //ok too!
	private static Map<String,  String> suitMap  = new HashMap<String , String>();  // ~ says same as on the left side (optional)
	//					value	word
	 ...
	 **************************************************************************************************/
	// We are using methods to initialize the suptMap and valueMap
	...
	//
	// if we called intializeMaps from a constructor it might never run
	// since we need to have data in suitMap and valueMap when the constructor runs
	// we tell Java to run initializeMaps() as soon as the application starts
	//
	// tp do so, define a static method outside any other part of the code
	...
	// We MUST call a super class ctro as the first thing we do in a subclass constructor
	// so the super class object that is automatically instantiated by Java gets initialized
	// Java has no idea how we want to initialize the super class object, so it makes us do it
