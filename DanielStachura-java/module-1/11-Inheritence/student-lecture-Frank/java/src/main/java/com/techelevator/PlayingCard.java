...
public class PlayingCard {
	 ...
	 *
	 * 	System.out.println("my Object" + myObject); // Java needs to convert object to a String
	 *
	 ...
	 * the optional @Override annotation tells the compiler to make sure my override has the same
 	 *	interface as the method I am overriding - make sure my override matches my superclass that I am trying to override
	 *******************************************************************************************/
	@Override   // for the Object class: String toString() - Object String method returns String / no parameters
	 ...
	 *
	 * We can't use @Override here to ask the compiler to help us to verify our override because
	 ...
	 * 	Why? - because we don't want to require a cast to our class when our class object is cloned
