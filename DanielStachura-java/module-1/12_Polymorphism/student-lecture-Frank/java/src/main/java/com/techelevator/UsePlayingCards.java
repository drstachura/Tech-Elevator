...
// We know this is the application program because it has the main() method
	public static void main(String[] args) {
		...
		aCard.showCard();	//use the super class to invoke a method - run the showCard() method for the object IN aCard
	...
	//		Polymorphism works with more than just 1 object - ArrayList
		ArrayList<PlayingCard> myCards = new ArrayList();	//Define ArrayList of super class objects
	//			  super class

		myCards.add(anItalianCard1);	// add sub class objects to my ArrayList of super class objects
		myCards.add(aUSACard);			// add sub class objects to my ArrayList of super class objects
		myCards.add(aSwissCard1);		// add sub class objects to my ArrayList of super class objects
		myCards.add(aUSACard2);			// add sub class objects to my ArrayList of super class objects
	...
	// Display all the objects in my ArrayList - Polymorphism will cause the correct showCard() for the element to be run
		for(PlayingCard theCard : myCards) {	//Define a super class object as an element in the for each
	...
	//method defined outside of main()
