...
//
@ResponseStatus(HttpStatus.NO_CONTENT)  // Return with a HTTP response of NO_CONTENT
...
//                                              rename the query parameter name to searchName in the method
        public List<Department> searchForADept(@RequestParam(value="name") String searchName) {
