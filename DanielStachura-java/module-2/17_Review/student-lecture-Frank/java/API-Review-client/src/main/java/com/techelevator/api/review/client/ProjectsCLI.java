...
import com.techelevator.api.review.client.model.*;
...
// Replace the DAO call to add the department with API call
		...
		//     We to create a request with the headers and new department - HttpEntity
...
// Replace the DAO call to add the department with API call
		...
		// Define array reference to hold result from API call - need this since the API interface doe snot return List objects
