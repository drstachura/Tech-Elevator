...
public class ProjectsCLI {
	...
	private void handleUpdateDepartmentName() {
		...
		if(allDepartments.length > 0) {
			...
			// getChoiceFromOptions() receives and array String and displays them as options to the user
	...
	private void handleEmployeeSearch() {
		...
		//      For this API call we have data in the query string: /employee?firstname=Leonard&lastname=McCoy
