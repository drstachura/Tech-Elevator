...
public class AuctionService {
    ...
    public Auction add(String auctionString) {
        ...
        HttpEntity aEntity = makeEntity(addAuction);
        try {
            addAuction = restTemplate.postForObject(API_URL, aEntity, Auction.class);
    ...
    public Auction update(String auctionString) {
        ...
        HttpEntity anEntity = makeEntity(updateAuction);
        try {
    ...
    public boolean delete(int id) throws RestClientResponseException, ResourceAccessException {
        try {
            ...
            console.printError(exception.getRawStatusCode() + ":" + exception.getStatusText());
            return null;
        }
        return true;
    }
