package com.techelevator.city; // same package as the POJO - .city

// DAO Interface for Table we want to access

import java.util.List;

// If one wants to be known as a CityDAO iut MUST implement these methods
public interface CityDAO {

	// NOTICE: Objects (City) are used in the DAO methods instead of individual variables
	//			except for find and delete methods (long)
