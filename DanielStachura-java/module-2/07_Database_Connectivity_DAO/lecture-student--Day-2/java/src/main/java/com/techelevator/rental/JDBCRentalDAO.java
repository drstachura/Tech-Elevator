...
public class JDBCRentalDAO implements RentalDAO {
    ...
    //***DELETE any dependent row on payment(in rental) before DELETE the rentals***
    ...
    Rental MapRowToRental(SqlRowSet aRow) {
        ...
        aRental.setRentalDate(aRow.getTimestamp("rental_date").toLocalDateTime()); //convert Date/Time/Timestamp to LocalDateTime
        ...
        //    the object data will automatically be set to null by Java
