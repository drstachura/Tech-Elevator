...
public class HotelController {
     ...
     */
    @PreAuthorize("isAuthenticated()")  // only allow access to this path is user is logged in (has a valid JWT)
     ...
     * @throws ReservationNotFoundException
     */
    @PreAuthorize("hasRole('ADMIN')")   // Only users with the ADMIN role may access this path to DELETE a reservation
    @ResponseStatus(HttpStatus.NO_CONTENT)
    @RequestMapping(path = "/reservations/{id}", method = RequestMethod.DELETE)
    // Principal theCurrentUser will tell Spring to pass us the Principal object for the currentuser
    //                                              and store it in the object theCurrentUser
     ...
     * @param username
     */
    // Display a message in the server log using the operation, reservation id and username passed to it
