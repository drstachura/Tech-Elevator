...
public class HotelController {
    ...
    // Principal theCurrentUser will tell Spring to pass us the Principal object for the current user
    //      and store it in the object called theCurrentUser
    public void delete(@PathVariable int id, Principal theCurrentUser) throws ReservationNotFoundException {
        // We need the currently logged in username(who called this path) to pass to the audit log
     ...
     * @param username
     */
    // Display a message in the server log using the username and operation, reservation id passed to it
