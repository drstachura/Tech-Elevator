...
function displayGroceries() {
  const theLi = document.getElementById('groceries');
    theGroceries.forEach( (aGrocery) => {
    const newElement = document.createElement('li');
    newElement.innerText = aGrocery
    theLi.insertAdjacentElement('afterbegin', newElement)
  });
}
